      ...
      <div className="max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center">
        <div>
          ...
          <h1 className="py-2 text-gray-700">
            Hi, I&apos;m <span className="text-[#5651e5]">Tettei</span>👋
          </h1>
          <h2 className="text-gray-700">Front-End Developer</h2>
          <p className="py-4 text-gray-600 max-w-[70%] m-auto">
            Building{" "}
            <RoughNotationGroup show={true}>
              <RoughNotation type="underline" color="#eb1700" padding={1}>
                highly performant,
              </RoughNotation>{" "}
              <RoughNotation type="underline" color="#fdd641" padding={1}>
                scalable
              </RoughNotation>{" "}
              and{" "}
              <RoughNotation type="underline" color="#5651E5" padding={1}>
                production-ready
              </RoughNotation>{" "}
            </RoughNotationGroup>
            web applications that your users will love.
          </p>
